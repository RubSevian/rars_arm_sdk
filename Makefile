#############################################################################
# Makefile for building: rars_arm
# Generated by qmake (3.1) (Qt 5.15.3)
# Project:  rars_arm.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile rars_arm.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = rars_arm1.0.0
DISTDIR = /home/ruben/rars_arm_sdk/.tmp/rars_arm1.0.0
LINK          = g++
LFLAGS        = 
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		rars_arm.pro include/arm_serial_port.hpp \
		include/arm_types.hpp \
		include/arm_motor_control.hpp src/arm_serial_port.cpp \
		src/arm_motor_control.cpp \
		examples/arm_sdk_test.cpp
QMAKE_TARGET  = rars_arm
DESTDIR       = 
TARGET        = rars_arm
...
Makefile: rars_arm.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		rars_arm.pro
	$(QMAKE) -o Makefile rars_arm.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/arm_serial_port.hpp include/arm_types.hpp include/arm_motor_control.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/arm_serial_port.cpp src/arm_motor_control.cpp examples/arm_sdk_test.cpp $(DISTDIR)/
...
arm_serial_port.o: src/arm_serial_port.cpp include/arm_serial_port.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o arm_serial_port.o src/arm_serial_port.cpp

arm_motor_control.o: src/arm_motor_control.cpp include/arm_motor_control.hpp \
		include/arm_serial_port.hpp \
		include/arm_types.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o arm_motor_control.o src/arm_motor_control.cpp

arm_sdk_test.o: examples/arm_sdk_test.cpp include/arm_motor_control.hpp \
		include/arm_serial_port.hpp \
		include/arm_types.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o arm_sdk_test.o examples/arm_sdk_test.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/rars_arm/bin || mkdir -p $(INSTALL_ROOT)/opt/rars_arm/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/rars_arm/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/rars_arm/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/rars_arm/bin/ 
